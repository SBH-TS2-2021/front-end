...
const resources = (props) => {
  ...
  return (
    ...
    <p>To learn more and apply visit the <a href="https://www.sba.gov/funding-programs/loans/covid-19-relief-options/paycheck-protection-program">PPP loan site.</a></p>

    <p className={style.finePrint}> *Results were predicted with {Math.round(props.LoanAmount[mostAccurate]*100)}% accuracy. No amounts are gaurenteed. </p>
    </div>
    )
  }
